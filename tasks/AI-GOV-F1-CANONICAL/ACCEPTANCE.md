...
4. commit exacto de integración en `main`, verificado mediante
   `git merge-base --is-ancestor <commit-de-integración> main` con
   código de salida `0`;
